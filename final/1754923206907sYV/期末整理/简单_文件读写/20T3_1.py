...
def number_of_words_in_dictionary(word_1, word_2):
    ...
    """
    # print()
    if word_1 == word_2 and word_1.islower():
        print(f"Could not find {word_1} in dictionary.")
    elif word_1 == word_2 and word_1.isupper():
        print(f"{word_1} is in dictionary.")
    elif word_1 != word_2:
        if word_1.islower() or word_2.islower():
            print(
                f"Could not find at least one of {word_1} and {word_2} in dictionary."
            )
        else:
            with open("dictionary.txt", "r") as file:
                ...
                for i in file:
                    ...
                    if word_2 == i:
                        b = sum2
            print(
                f"Found {abs(a-b)+1} words between {word_1} and {word_2} in dictionary."
            )
